 ...
 * @ORM\Entity(repositoryClass="GestionBoutiquesBundle\Repository\CategorieRepository")
 */
class Categorie
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="GestionBoutiquesBundle\Entity\ProduitBoutique", mappedBy="categorie")
     */
    private $produits;
