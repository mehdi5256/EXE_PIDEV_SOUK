...
class Event
{
     ...
     * Add participant
     *
     * @param \EvenementBundle\Entity\UserE $participant
     *
     * @return Event
     */
    public function addParticipant(\EvenementBundle\Entity\UserE $participant)
    {
     ...
     * @param \EvenementBundle\Entity\UserE $participant
     */
    public function removeParticipant(\EvenementBundle\Entity\UserE $participant)
    {
     ...
     * Add participate
     *
     * @param \EvenementBundle\Entity\UserE $participate
     *
     * @return Event
     */
    public function addParticipate(\EvenementBundle\Entity\UserE $participate)
    {
     ...
     * @param \EvenementBundle\Entity\UserE $participate
     */
    public function removeParticipate(\EvenementBundle\Entity\UserE $participate)
    {
